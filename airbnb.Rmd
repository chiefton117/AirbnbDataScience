...
ggplot(data = listings, mapping = aes(x = price, y = number_of_reviews, color = neighbourhood_group_cleansed)) +
  geom_point() +
  theme_bw() 
...
plot_nyc(data = listings,
           values = 'price',
           regions = 'neighbourhood_group_cleansed',
           color = 'black')
