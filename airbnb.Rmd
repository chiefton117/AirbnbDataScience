...
# dt_frame$quartile <- with(dt_frame$priceNum, factor(
...
#dt_frame <- cbind(Rating = as.factor(classify(dt_frame$review_scores_rating)), dt_frame)
...
#dt_frame_lbl <- as.data.frame(as.factor(ifelse(dt_frame$review_scores_rating >= 90, "good", "poor")))
