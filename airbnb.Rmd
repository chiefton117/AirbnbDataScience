...
ggplot(data = scatter %>% filter(number_of_reviews < 500, review_scores_rating > 80), mapping = aes(x = review_scores_rating, y = number_of_reviews, color = neighbourhood_group_cleansed)) +
  geom_point() +
